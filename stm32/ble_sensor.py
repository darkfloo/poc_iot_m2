...
class BLESensor:
	...
	def __init__(self, ble, name='FLO_FINAL'):
		self._ble = ble
	...
	def set_data_env(self, timestamp, pressure, humidity, temperature,analog, notify):
		self._ble.gatts_write(self._env_handle, pack('<HiHhH', timestamp, pressure, humidity,temperature , analog))
		if notify:
